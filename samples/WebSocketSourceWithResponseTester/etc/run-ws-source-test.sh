...
streamtool submitjob -d d1 -i i1 ~/workspace32/WebSocketSourceWithResponseTester/output/com.ibm.streamsx.websocket.sample.WebSocketSourceWithResponseTester.sab -P maxClientConnectionsAllowed=64 -P nonTlsEndpointNeeded=true -P allowHttpPost=true -P clientWhitelist='["10.6.33.13", "10.6.33.17", "10.6.100.124", "10.6.100.168", "10.6.100.169", "10.6.100.170", "10.6.100.171"]' -P urlContextPath='["MyServices/Banking/Deposit", "", "Love/Is/God", "Work/Is/Worship"]'
...
# [Please note that this application offers many submission time parameters. We are using only a few here.]
streamtool submitjob -d d1 -i i1 ~/workspace32/WebSocketSourceWithResponseTester/output/com.ibm.streamsx.websocket.sample.WebSocketHttpClientApp.sab -P url=https://b0513:8443/MyServices/Banking/Deposit -P tlsAcceptAllCertificates=true

streamtool submitjob -d d1 -i i1 ~/workspace32/WebSocketSourceWithResponseTester/output/com.ibm.streamsx.websocket.sample.WebSocketHttpClientApp.sab -P url=https://b0513:8443/MyServices/Banking/Deposit -P tlsAcceptAllCertificates=true

streamtool submitjob -d d1 -i i1 ~/workspace32/WebSocketSourceWithResponseTester/output/com.ibm.streamsx.websocket.sample.WebSocketHttpClientApp.sab -P url=https://b0513:8443/MyServices/Banking/Deposit -P tlsAcceptAllCertificates=true

streamtool submitjob -d d1 -i i1 ~/workspace32/WebSocketSourceWithResponseTester/output/com.ibm.streamsx.websocket.sample.WebSocketHttpClientApp.sab -P url=http://b0513:8080/MyServices/Banking/Deposit -P tlsAcceptAllCertificates=true
